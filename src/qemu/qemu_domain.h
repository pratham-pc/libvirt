...
void qemuDomainObjFreeJob(qemuDomainObjPrivatePtr priv);

int qemuDomainObjInitJob(qemuDomainObjPrivatePtr priv);

bool qemuDomainJobAllowed(qemuDomainObjPrivatePtr priv, qemuDomainJob job);
